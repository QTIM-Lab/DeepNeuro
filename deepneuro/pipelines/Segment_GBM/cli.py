...
class Segment_GBM_cli(object):
    ...
    def docker_pipeline(self):
        ...
        nvidia_docker_wrapper(['segment_gbm', 'pipeline'], vars(args), ['output_folder', 'T2', 'T1', 'T1POST', 'FLAIR', 'input_directory', 'wholetumor_output', 'enhancing_output'], docker_container='qtimlab/deepneuro_segment_gbm:latest')
