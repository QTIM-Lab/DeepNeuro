...
from deepneuro.augmentation.augment import Flip_Rotate_2D, ExtractPatches, MaskData
...
def train_Segment_GBM(data_directory, val_data_directory):
    ...
    training_data = '/mnt/jk489/QTIM_Databank/DeepNeuro_Datasets/data_synthesis_323232_large.h5'
    model_file = 'data_synthesis_323232_large_model.h5'
    testing_data = './data_synthesis_323232_large_test.h5'
    ...
    if train_model:
        ...
        # Add Missing Data Augmentation
        mask_augmentation = MaskData(num_masked=1, masked_value=-10, data_groups=['input_modalities'], random_sample=False)
