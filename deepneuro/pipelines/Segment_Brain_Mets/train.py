...
from deepneuro.preprocessing.singal import ZeroMeanNormalization
...
TestingParameters = {'inputs': ['input_data'],
               'output_filename': '_inference_segmentation.nii.gz',
               'batch_size': 20,
...
ErrorStatistics = ErrorCalculation(output_log='inference_statistics', cost_functions=['dice', 'msq'])
