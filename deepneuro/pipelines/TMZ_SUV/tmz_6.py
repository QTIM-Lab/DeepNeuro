...
def train_Segment_GBM(data_directory, val_data_directory):
    ...
    ['*FLAIR*nii.gz', ['*T2SPACE*nii.gz'], ['*MPRAGE_POST*nii.gz'], ['*MPRAGE_Pre*nii.gz'], 'DSC_GE_CBV_r_T2.nii.gz','DSC_GE_rBF_r_T2.nii.gz'],
    ...
    training_data = '/mnt/jk489/QTIM_Databank/DeepNeuro_Datasets/TMZ_6_323232.h5'
    model_file = 'TMZ_6_323232_model.h5'
    testing_data = './TMZ_6_323232_test.h5'
    ...
    if train_model:
        ...
        model_parameters = {'input_shape': (32, 32, 32, 6),
    ...
    if predict:
        ...
        testing_parameters = {'inputs': ['input_modalities'], 
                        'output_filename': 'deepneuro_suv_6.nii.gz',
                        'batch_size': 50,
                        'patch_overlaps': 6,
