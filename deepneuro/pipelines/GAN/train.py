...
def train_Segment_GBM(data_directory, val_data_directory):
    ...
    ['*FLAIR*', ['*T2SPACE*'], ['*T1Pre_r_T2.nii.gz'], ['*T1Post_r_T2.nii.gz']],
    'ground_truth': ['*MPRAGE_POST*']}
    ...
    training_data = '/mnt/jk489/QTIM_Databank/DeepNeuro_Datasets/MPRAGE_upsampling_323232.h5'
    ...
    print 'GETTING READY TO LOAD MODEL'
