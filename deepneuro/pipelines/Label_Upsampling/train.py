...
from deepneuro.augmentation.augment import Flip_Rotate_2D, ExtractPatches, MaskData, Downsample
...
def train_Segment_GBM(data_directory, val_data_directory):
    ...
    ['*FLAIR*', ['*T2SPACE*', '*T2_pp*'], ['*T1_pp.*', '*MPRAGE_Pre*'], ['*T1post_pp.*', '*MPRAGE_POST*'], ['enhancing*']],
    'ground_truth': ['enhancing*']}
