...
class ModelPatchesDiagram(ModelPatchesInference):
    ...
    def load(self, kwargs):
        ...
        super(ModelPatchesDiagram, self).load(kwargs)
    ...
    def generate_marker_patch(self, input_patches, border_width=1):

        output_patches = np.ones_like(input_patches)

        front_border_slice = [slice(border_width, -border_width, None) for dim in self.patch_dimensions]
